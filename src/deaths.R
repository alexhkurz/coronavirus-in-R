...
plot(region1_deaths, col="black", main=paste(cd[r1,2], "(black) vs", cd[r2,2],  "(red):", "lag =",region2_first-region1_first, "days"), xlab="days", ylab=paste(cd[r1,2], "deaths"))   
