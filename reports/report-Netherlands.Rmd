...
```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Netherlands",region2="Italy",lag=40)
```

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Netherlands",region1_pop="Russian Federation",region2="Italy",lag=35)
```
