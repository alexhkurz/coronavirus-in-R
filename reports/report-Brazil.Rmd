...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Brazil",region2="Italy",lag=30)
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Brazil",region2="Italy",lag=29)
```
