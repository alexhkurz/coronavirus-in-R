...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="US",region1_pop="United States" ,region2="Italy",last_day="3/12/20",range=12,lag=15)
```

## March 19

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="US",region1_pop="United States",region2="Italy",last_day="3/19/20",range=18,lag=16) 
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="US",region1_pop="United States",region2="Italy",last_day="3/19/20",range=18,lag=18) 
```

## March 27

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="US",region1_pop="United States",region2="Italy",last_day="3/27/20",lag=14)
```


```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="US",region1_pop="United States",region2="Italy",last_day="3/27/20",lag=19)
```

## April 2

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="US",region1_pop="United States",region2="Italy",last_day="4/2/20",lag=13)
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="US",region1_pop="United States",region2="Italy",last_day="4/2/20",lag=20)
```
