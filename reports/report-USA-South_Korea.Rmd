...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="US",region1_pop="United States",region2="Korea, South",region2_pop="Korea, Rep.",range=30, last_day="3/15/20",lag=21) 
```


```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="US",region1_pop="United States",region2="Korea, South",region2_pop="Korea, Rep.",range=50) 
```
