...
The program that produces the plots is available as [report-Orange-deaths.Rmd](https://github.com/alexhkurz/coronavirus-in-R/blob/master/reports/report-Orange-deaths.Rmd). It is easy to download the program and to modify the relevant parameters for your own experiments, see the [README](https://github.com/alexhkurz/coronavirus-in-R/) for more details.
