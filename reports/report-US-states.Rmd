...
The program that produces the plots below is available as [report-USA-states.Rmd](https://github.com/alexhkurz/coronavirus-in-R/blob/master/reports/report-USA-states.Rmd). It is easy to download the program and to modify the relevant parameters for your own experiments, see the [README](https://github.com/alexhkurz/coronavirus-in-R/) for more details.
...
If we plot the deaths per million of all states, it looks as if New York and maybe a few others were badly affected, but the other states would not have to worry too much. 
...
But the problem with this picture is that for the states with smaller number of deaths it is not possible to see whether they are on an exponential growth trajectory or not. In other words, are they doing genuinely better than New York, or are they doing just as badly and are only lagging behind in time?

To answer this question let us zoom into the picture. 

We start with the states **ranked 1-5**:
...
Here are the states of **rank 10-20**:
