...
Here for the **latest charts**:


```{r, echo=FALSE}
one_region(what="deaths",data=deaths_global,region="Italy")
```


```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Germany",region2="Italy",lag=22)
```

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Germany",region2="Italy",lag=10)
```
