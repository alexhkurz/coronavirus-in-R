---
title: "Coronavirus in Philippines"
...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Philippines",region2="Italy",lag=34)
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Philippines",region2="Italy",lag=32)
```
