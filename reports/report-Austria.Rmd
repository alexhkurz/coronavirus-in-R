...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Austria",region2="Italy",last_day="3/19/20",range=18,lag=8) 
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Austria",region2="Italy",last_day="3/19/20",range=18,lag=18) 
```

## March 27

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Austria",region2="Italy",last_day="3/27/20",lag=6)
```


```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Austria",region2="Italy",last_day="3/27/20",lag=19)
```
