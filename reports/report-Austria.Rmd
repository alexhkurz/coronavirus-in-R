...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Austria",region2="Italy",lag=7)
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Austria",region2="Italy",lag=20)
```
