...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Sweden",region2="Norway",lag=10)
```

```{r, echo=FALSE}
two_regions(what="deaths",data=deaths_global,region1="Sweden",region2="Norway",lag=0)
```
