...
```{r, echo=FALSE}
two_regions(what="cases",data_global=cases_global,data_us=cases_us,admin2="New York",province_state="New York",region2="Italy",last_day="3/12/20",range=18,lag=13) 
```
...
```{r, echo=FALSE}
two_regions(what="deaths",data_global=deaths_global,data_us=deaths_us,admin2="New York",province_state="New York",region2="Italy",last_day="3/27/20",range=18,lag=13) 
```

And, as worrying, the lag in the number of cases has totally disappeared:

```{r, echo=FALSE}
two_regions(what="cases",data_global=cases_global,data_us=cases_us,admin2="New York",province_state="New York",region2="Italy",last_day="3/27/20",lag=0)
```
