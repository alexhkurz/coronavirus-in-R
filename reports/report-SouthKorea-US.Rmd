...
```{r, echo=FALSE}
one_region(what="deaths",data=deaths_global,region="US",last_day="3/22/20",range=20)
```
 

```{r, echo=FALSE}
two_regions(what="deaths",data=cases_global,region1="Korea, South",region2="US",last_day="3/22/20",range=20,lag=15)
```
