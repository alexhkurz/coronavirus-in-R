...
I would expect that cities are worse affected than less densely populated areas, but Los Angeles is on a flatter trajectory than Italy:

```{r, echo=FALSE}
two_regions(what="deaths",data_global=deaths_global,data_us=deaths_us,admin2="Los Angeles",province_state="California",region2="Italy",lag=28)
```

```{r, echo=FALSE}
two_regions(what="cases",data_global=cases_global,data_us=cases_us,admin2="Los Angeles",province_state="California",region2="Italy",lag=22)
```
