...
The program that produces the plots is available as [report-Sweden.Rmd](https://github.com/alexhkurz/coronavirus-in-R/blob/master/reports/report-Sweden.Rmd). It is easy to download the program and to modify the relevant parameters for your own experiments, see the [README](https://github.com/alexhkurz/coronavirus-in-R/) for more details.
...
```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Sweden",region2="Italy",last_day="3/11/20",range=12,lag=8)
```

## March 18

```{r, echo=FALSE}
two_regions(what="cases",data=cases_global,region1="Sweden",region2="Italy",last_day="3/18/20",range=18,lag=10) 
```
