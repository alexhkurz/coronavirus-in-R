...
`germany_first` can be chosen as the first day of a recorded coronavirus death in Germany' or just as 30 days ago, or as the number of days that have passed in the current month or ...

`italy_first` is the corresponding day which produce the best match of the two curves. At the time of writing this was approx `germany_first+19`.
...
Show the last date for which there is data (recall `ncol` from the first lesson):
