...
deaths_counties_pivoted <- top_n(deaths_counties_pivoted, 100, deaths_per_million)
...
- [line plots](http://www.sthda.com/english/wiki/ggplot2-line-plot-quick-start-guide-r-software-and-data-visualization)
...
- [select top or bottom entries](https://dplyr.tidyverse.org/reference/top_n.html)
