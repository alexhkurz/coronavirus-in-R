...
```{r}
### Filter counties, states, etc
deaths_us_unassigned <- filter(deaths, (County=="Unassigned"))
deaths_us_out_of <- filter(deaths, grepl("Out of",County))
deaths_us_counties <- filter(deaths, !(County=="") & !(County=="Unassigned") & grepl("Out of",County))
```
